...
// Fugsi getServerSideProps akan dipanggil setiap kali halaman ini diakases dan akan mengambil data produk dari API sebelum merender halaman.
...
{/digunakan static-site generator/}
